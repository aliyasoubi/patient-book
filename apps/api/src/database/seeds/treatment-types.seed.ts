...
export const TREATMENT_TYPES: TreatmentSeed[] = [
  ...
  {
    code: 'gum_lift',
    nameFa: 'جراحی لیفت لثه',
    nameEn: 'Gum lift',
    sheetColumn: 'جراحی لیفت لثه',
    icon: 'expand',
    color: 'pink',
    sortOrder: 120,
  },
